...
urlpatterns = [
    ...
    path('detail-tayangan-series/<str:id>/', detail_tayangan_series, name='detail_tayangan_series'),
    path('detail-tayangan-episode/<str:id>/<str:name>/', detail_tayangan_episode, name='detail_tayangan_episode'),
